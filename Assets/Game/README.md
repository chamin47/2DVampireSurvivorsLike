...
`Assets/Game/Scenes/FarmSurvivors.unity`를 열고 Play를 누르면 시작 화면이 표시됩니다.
...
- 화면 구성: `Assets/Game/Scripts/UI/FarmGameUI.cs`
- 다국어 문구: `Assets/Game/Scripts/Presentation/FarmLocalization.cs`
